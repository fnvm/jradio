...
public class Player {
    ...
    public void play(RadioStation station) {
        ...
        try {
            ProcessBuilder builder = new ProcessBuilder(ffplayCommand, "-nodisp", "-autoexit", "-loglevel", "quiet", url);
    ...
    private void fetchMetadata() {
        if (currentStation == null || currentStation.getUrl().isEmpty()) return;
            ...
            if (part.contains("=")) {
                ...
                if (key.equalsIgnoreCase("StreamTitle")) {
                    ...
                    if (terminalManager != null) {
                    	terminalManager.print("\u001B[90m");
                        terminalManager.print("\r\033[K  >> " + "[" + currentStation.getName() + "] " + streamTitle);
                        terminalManager.print("\u001B[0m");
